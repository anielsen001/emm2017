...
/*
 *
 *  Revision Number: $Revision: 1393 $
 *  Last changed by: $Author: awoods $
 *  Last changed on: $Date: 2015-12-10 13:48:21 -0700 (Thu, 10 Dec 2015) $
...
int main()
{
    ...
    char VersionDate_Large[] = "$Date: 2017-06-28 16:13:21 -0600 (Wed, 28 Jun 2017) $";
    char VersionDate[12];
    char ans[20];
    FILE *fileout;
